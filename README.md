...
DEFAULT_ALLOWED_TOOLS=Read,TaskCreate,TaskUpdate,TaskList

# Standard (file editing + git operations)
DEFAULT_ALLOWED_TOOLS=Read,Write,Edit,MultiEdit,Bash(git *),TaskCreate,TaskUpdate,TaskList

# Aggressive (auto-approve nearly everything)
DEFAULT_ALLOWED_TOOLS=Read,Write,Edit,MultiEdit,Bash(*),TaskCreate,TaskUpdate,TaskList,WebSearch,WebFetch
```
